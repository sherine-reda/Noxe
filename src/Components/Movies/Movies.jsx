...
export default function Movies() {
  ...
  async function getMovies(page) {
    ...
    let { data } = await axios.get(
      `https://api.themoviedb.org/3/discover/movie?api_key=643a1195f74a078cff8b3ed415464bed&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`
    );
